...
<%-- Begin Customization for more info --%>

<%
	String moreInfoUrl = GetterUtil.getString(preferences.getValue("moreInfoUrl", ""));
	String moreInfoUrlLabel = (GetterUtil.getString(preferences.getValue("moreInfoUrlLabel", ""))!="" ? GetterUtil.getString(preferences.getValue("moreInfoUrlLabel", "")) : "View All");
	if (Validator.isNotNull(moreInfoUrl)) {
%>
<div class="cross-portlet-horizontal-border"></div>
<div style="text-align:right; padding-bottom: 25px;"><a class="read-more" href="<%= moreInfoUrl %>"><%=moreInfoUrlLabel %></a></div>
<%
	}
%>
<%-- End Customization for more info --%>
